...
.. raw:: html
   ...
   <div class="grid-container">
      ...
      <!-- xDiT -->
      <div class="project-card">
         <div class="card-top"><div class="card-icon" style="background-image: url('_static/images/pytorch.png')"></div><h3 class="card-title">xDiT</h3></div>
         <p class="card-desc">扩散模型推理加速框架，支持昇腾 NPU 单卡/多卡加速图像生成。</p>
         <div class="card-footer"><a href="https://github.com/xdit-project/xDiT">官方链接</a><span class="split">|</span><a href="sources/xdit/quick_start.html">快速上手</a></div>
      </div>
