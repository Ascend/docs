...
.. raw:: html
   ...
   <div id="verl-portal">
      ...
      <div class="verl-quick-grid">
         <a href="onboarding_getting_started/ascend_quick_start.html" class="verl-quick-card">
            <div style="font-size: 2rem;">📚</div>
            <h4>启航入门</h4>
         </a>
         <a href="core_features_application_guide/ascend_backend_features.html" class="verl-quick-card">
            <div style="font-size: 2rem;">🔧</div>
            <h4>应用指南</h4>
         </a>
         <a href="porting_performance_tuning/ascend_performance_analysis_guide.html" class="verl-quick-card">
            <div style="font-size: 2rem;">⚙️</div>
            <h4>性能调优</h4>
         </a>
         <a href="open_source_development/ascend_ci_guide_zh.html" class="verl-quick-card">
            <div style="font-size: 2rem;">👨‍💻</div>
            <h4>开源开发</h4>
         </a>
      </div>
...
.. toctree::
   ...
   onboarding_getting_started/ascend_quick_start
   onboarding_getting_started/ascend_sglang_quick_start
   onboarding_getting_started/dockerfile_build_guidance
...
.. toctree::
   ...
   core_features_application_guide/ascend_backend_features
   core_features_application_guide/ascend_sglang_best_practices
   core_features_application_guide/ascend_retool_best_pratice
   core_features_application_guide/ascend_qwen3-langSeq_practices
...
.. toctree::
   ...
   porting_performance_tuning/ascend_consistency
   porting_performance_tuning/ascend_performance_analysis_guide
   porting_performance_tuning/ascend_profiling_en
   porting_performance_tuning/ascend_profiling_zh
   porting_performance_tuning/dapo_multi_model_optimization_practice
   porting_performance_tuning/gspo_optimization_practice
...
.. toctree::
   ...
   open_source_development/ascend_ci_guide_zh